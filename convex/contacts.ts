...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const id = await ctx.db.insert("contacts", {
      ...
      linkedInPhotoFetchedAt: args.linkedInPhotoFetchedAt?.trim(),
      linkedInUrl: args.linkedInUrl?.trim(),
      researchSummary: args.researchSummary?.trim(),
      displaySummary: args.displaySummary?.trim(),
      researchTaskId: args.researchTaskId?.trim(),
      researchTaskStatus: args.researchTaskStatus?.trim(),
